...
struct ShellTabsOptions;
	...
	private:
		...
		bool AppendPathFromPidl(PCIDLIST_ABSOLUTE pidl, std::vector<std::wstring>& paths) const;
                ...
                void DispatchSaveSelectionAsIsland(const std::vector<std::wstring>& paths) const;
		...
		HWND m_listView = nullptr;
                ...
                std::vector<std::wstring> m_contextMenuSelectionPaths;
                bool m_pendingMultiSelection = false;
                bool m_contextMenuInserted = false;
                static constexpr UINT kOpenInNewTabCommandId = 0xE170;
                static constexpr UINT kOpenSelectionInNewTabsCommandId = 0xE171;
                static constexpr UINT kSaveSelectionAsIslandCommandId = 0xE172;
