...
struct ShellTabsOptions;
		...
		bool InstallBreadcrumbSubclass(HWND toolbar);
                ...
                HWND FindExplorerListViewWindow(HWND root) const;
                HWND FindExplorerTreeViewWindow(HWND root) const;
		...
		bool m_frameSubclassInstalled = false;
                ...
                bool m_explorerPaneRetryScheduled = false;
                UINT m_explorerPaneRetryDelayMs = 0;
