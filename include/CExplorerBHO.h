...
class ShellTabsListView;
		...
		bool InstallBreadcrumbSubclass(HWND toolbar);
                ...
                void ClearTravelToolbarPressContext();
                ...
                bool IsStatusBarOnCurrentThread() const;
		...
		COLORREF m_breadcrumbFontGradientEndColor = RGB(255, 255, 255);
                ...
                UINT m_travelToolbarPressedCommandId = 0;
                RECT m_travelToolbarPressedRect{};
